...
The amount spent was 211.27 dollars throughout the entire process, which came out to 39.6% under budget. Of that, only 104.62 dollars was spent on the final prototype, coming out to 29.9% of the budget. That cost further breaks down to be only 29.30 dollars on the 3D printed components, which can be drastically reduced if mass-produced with injection molding (3).
